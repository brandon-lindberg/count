...
from app.services.polling import get_due_steam_app_ids, poll_app
...
async def main() -> None:
    ...
    scheduler.add_job(import_registry_job, "interval", hours=settings.registry_import_hours, id="import_registry", replace_existing=True)
